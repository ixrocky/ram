...
from SaregamaMusic.core.call import AMBOTOP, autoend, counter
from SaregamaMusic.utils.database import get_client, set_loop, is_active_chat, is_autoend, is_autoleave
import logging

async def auto_leave():
    while not await asyncio.sleep(86400):
        from SaregamaMusic.core.userbot import assistants
