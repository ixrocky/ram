...
from SaregamaMusic.core.call import from pyrogram import filters
from pyrogram.types import Message

from SaregamaMusic import app
from SaregamaMusic.core.call import AMBOTOP
from SaregamaMusic.utils.database import is_music_playing, music_on
...
async def resume_com(cli, message: Message, _, chat_id):
    ...
    await music_on(chat_id)
    try:
        await from pyrogram import filters
from pyrogram.types import Message
